...
public final class GuiLanguage {
    public static void init() {
        ...
        add("gui.mae2a.max_item_input_placeholder", "请输入最大物品数量", "Enter max item quantity (0-64)");
        add("gui.mae2a.max_fluid_input_placeholder", "请输入最大流体数量", "Enter max fluid volume (0-1000mB)");
        ...
        add("gui.mae2a.min_input_tip", "输入0来禁用，产物数量不会低于设定下限",
                "Enter 0 to disable - Output quantity will not fall below the set lower limit");
