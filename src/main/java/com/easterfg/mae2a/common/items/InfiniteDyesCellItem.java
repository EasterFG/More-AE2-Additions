...
public class InfiniteDyesCellItem extends AEBaseItem implements ICellWorkbenchItem {
    ...
    public InfiniteDyesCellItem(Properties properties) {
        super(properties);
    }
    ...
    @OnlyIn(Dist.CLIENT)
    @Override
    public void appendHoverText(@NotNull ItemStack stack, Level level, @NotNull List<Component> lines,
            @NotNull TooltipFlag advancedTooltips) {
        lines.add(Component.translatable("tooltip.mae2a.infinite_dyes_cell")
                .withStyle(style -> style.withColor(TooltipHelper.GRADIENT.getCurrent())));
    }
